...
representation. For details, see "Rendering a site page".
...
**** DONE Pandoc categories certain valid internal links as "spurious" and emits them as spans; add custom handling for these :hard:mid:
