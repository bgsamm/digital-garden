...
**** TODO Use ~code~ instead of =verbatim= where appropriate       :easy:low:
...
**** TODO More robust ID generation :easy:med:
...
**** TODO Add reference to "wrap your dependencies" :easy:low:
**** TODO Add reference to "reinvent the wheel" (pandoc.write) :easy:low:
...
**** TODO Insert link to pandoc library documentation :easy:low:
**** TODO Insert link to to-do handling :easy:low:
**** TODO Better document my knowledge of how Pandoc exports Org files :med:low:
...
**** TODO Add link to "Preparing the build directtory" :easy:low:
