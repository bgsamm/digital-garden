...
**** TODO Split into "Regex" and "HTML" sections?
...
filtering for files with the '.org' extension (since Emacs
auomatically creates back-up versions of files in the same directory
