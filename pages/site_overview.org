...
:Date: 2025-12-29
:Category: Meta
:Abstract: A high-level overview of the principles behind the site's design.
:END:

#+INCLUDE: "global_options.org"

**** TODO Organize these TODOs...                                  :med:high:
**** TODO Tag these TODOs                                         :easy:high:

**** TODO Create an Emacs-specific page for these                  :easy:low:
# Emacs/org-mode TODOs
**** TODO Figure out whether linking to list items is possible      :med:mid:
**** TODO System for organizing TODO & DONE items                  :med:high:

**** TODO Implement to-do tracking pages (per-page + global)
**** TODO Figure out site-wide quote integration
**** DONE TODO priority tagging system
...
**** TODO Jump links to usage locations for a noweb block/symbol
**** TODO Design principle regarding "premature optimization"?
**** TODO Something about "assert assumptions rather than cover for every case" ("assume and assert"?) :easy:low:
**** TODO Something about "the rule of three" (e.g. max three levels of nesting)
**** TODO "Don't solve problems you don't yet have"
**** TODO "Assume and assert"
**** TODO Custom "100 X Challenge" view?                           :hard:med:
**** TODO Adaptive site layout                                    :hard:high:
**** TODO Glossary/footnote system for acronyms                    :hard:med:
**** TODO Principle regarding separating I/O from rest of code     :easy:low:
